...
public class CircularSeekBar extends View {
     ...
     */
    protected float mCircleStrokeWidth = dp2Px(getContext(),3);
     ...
     */
    protected float mPointerRadius = dp2Px(getContext(),4);
     ...
     */
    protected float mStartAngle = 270;
    ...
    public void setmCircleStrokeWidth(float mCircleStrokeWidth) {
        this.mCircleStrokeWidth = mCircleStrokeWidth;
    }

    public void setmPointerRadius(float mPointerRadius) {
    ...
    public void setmCircleXRadius(float mCircleXRadius) {
        this.mCircleXRadius = mCircleXRadius;
    }

    public void setmCircleYRadius(float mCircleYRadius) {
        this.mCircleYRadius = mCircleYRadius;
    }
...
//        mProgress = attrArray.getInt(R.styleable.CircularSeekBar_progresss, DEFAULT_PROGRESS);
...
//        mCircleProgressGlowPaint.setMaskFilter(new BlurMaskFilter((5f * DPTOPX_SCALE), BlurMaskFilter.Blur.NORMAL));
     ...
     *
     * @param value. True if the pointer should lock at zero and max, false if it should not.
     */
